...
#define LIBCFG_CKCU_INTERRUPT_FLAG_V01    (1)
#define LIBCFG_GPIOC                      (1)
#define LIBCFG_VDD_5V                     (1)
#define LIBCFG_MCTM0                      (1)
#define LIBCFG_WAKEUP_V01                 (1)
#define LIBCFG_PWRCU_WAKEUP1              (1)
#define LIBCFG_PWRCU_PORF                 (1)
#define LIBCFG_SINK_CURRENT_ENHANCED      (1)
...
#define LIBCFG_NO_FMC_PRE_FETCH           (1)
#define LIBCFG_NO_FMC_WAIT_STATUS         (1)
