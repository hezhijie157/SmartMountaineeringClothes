...
#define CKCU_FLAG_LSIRDY        (1UL << 5)
  ...
  #endif
#else
#define IS_CKCU_FLAG(FLAG)      (((FLAG & 0xFFFFFFC3) == 0) && (FLAG != 0))
#endif
...
#if (LIBCFG_CKCU_INTERRUPT_FLAG_V01)
#define IS_CKCU_INT_FLAG(FLAG)  (((FLAG & 0xFFFFFFFE) == 0) && (FLAG != 0))
#else
...
#define IS_CKCU_DBG(MODE)       (((MODE & ~(0x33FFFFDF)) == 0) && (MODE != 0))
