...
void ADC_RegularGroupConfig(HT_ADC_TypeDef* HT_ADCn, u8 ADC_MODE, u8 Length, u8 SubLength)
{
  ...
  HT_ADCn->CR =  ((u32)(SubLength - 1) << 16) | ((u32)(Length - 1) << 8) | ADC_MODE | (HT_ADCn->CR & 0x80);
}
 ...
 *     @arg ADC_TRIG_MCTMx_MTO  : where x can be 0
 *     @arg ADC_TRIG_MCTMx_CH0O : where x can be 0
 *     @arg ADC_TRIG_MCTMx_CH1O : where x can be 0
 *     @arg ADC_TRIG_MCTMx_CH2O : where x can be 0
 *     @arg ADC_TRIG_MCTMx_CH3O : where x can be 0
 ...
 *     @arg ADC_TRIG_PWMx_MTO   : where x can be 0 ~ 1
 *     @arg ADC_TRIG_PWMx_CH0O  : where x can be 0 ~ 1
 *     @arg ADC_TRIG_PWMx_CH1O  : where x can be 0 ~ 1
 *     @arg ADC_TRIG_PWMx_CH2O  : where x can be 0 ~ 1
 *     @arg ADC_TRIG_PWMx_CH3O  : where x can be 0 ~ 1
 * @retval None
 ************************************************************************************************************/
