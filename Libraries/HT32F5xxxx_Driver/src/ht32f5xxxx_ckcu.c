...
void CKCU_DeInit(void)
{
  ...
  #if (LIBCFG_CKCU_INTERRUPT_FLAG_V01)
  HT_CKCU->GCIR = 0x00000001;                    /* Clear all interrupt flags                               */
  #else
 ...
 *          CKCU_DBG_WDT_HALT,
 *          CKCU_DBG_PWM0_HALT, CKCU_DBG_PWM1_HALT
 * @param Cmd: This parameter can be ENABLE or DISABLE.
 * @retval None
 ************************************************************************************************************/
 ...
 *        @arg CKCU_ATC_EXT_PIN:CKIN is selected as reference clock
 * @retval None
 ************************************************************************************************************/
