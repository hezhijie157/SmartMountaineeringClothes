...
u8 OV7725_Init(void)
{
    ...
    CKCU_PeripClockConfig(CKCUClock, ENABLE);
		...
		// OV7725_VSYNC
		AFIO_GPxConfig(OV7725_VSYNC_PORT, OV7725_VSYNC_PIN, AFIO_MODE_DEFAULT);//HZJ  Want Check again!!
		GPIO_DirectionConfig(GPIO_PORT[OV7725_VSYNC_PORT], OV7725_VSYNC_PIN, GPIO_DIR_IN);
		GPIO_InputConfig(GPIO_PORT[OV7725_VSYNC_PORT],OV7725_VSYNC_PIN,ENABLE);
		GPIO_PullResistorConfig(GPIO_PORT[OV7725_VSYNC_PORT],OV7725_VSYNC_PIN, GPIO_PR_UP);//HZJ Input PULLUP

	 // OV7725_WRST
    AFIO_GPxConfig(OV7725_WRST_PORT, OV7725_WRST_PIN, AFIO_MODE_DEFAULT);  //HZJ  Want Check again!!
		GPIO_DirectionConfig(GPIO_PORT[OV7725_WRST_PORT], OV7725_WRST_PIN, GPIO_DIR_OUT);
    GPIO_OpenDrainConfig(GPIO_PORT[OV7725_WRST_PORT], OV7725_WRST_PIN, DISABLE);//HZJ		
		
		
		// OV7725_WREN
    AFIO_GPxConfig(OV7725_WREN_PORT, OV7725_WREN_PIN, AFIO_MODE_DEFAULT);  //HZJ  Want Check again!!
		GPIO_DirectionConfig(GPIO_PORT[OV7725_WREN_PORT], OV7725_WREN_PIN, GPIO_DIR_OUT);
    GPIO_OpenDrainConfig(GPIO_PORT[OV7725_WREN_PORT], OV7725_WREN_PIN, DISABLE);//HZJ			
		
		//OV7725_RCK
		AFIO_GPxConfig(OV7725_RCK_PORT, OV7725_RCK_PIN, AFIO_MODE_DEFAULT);  //HZJ  Want Check again!!
		GPIO_DirectionConfig(GPIO_PORT[OV7725_RCK_PORT], OV7725_RCK_PIN, GPIO_DIR_OUT); 
		GPIO_OpenDrainConfig(GPIO_PORT[OV7725_RCK_PORT], OV7725_RCK_PIN, DISABLE);//HZJ		
		
		//OV7725_RRST
    AFIO_GPxConfig(OV7725_RRST_PORT, OV7725_RRST_PIN, AFIO_MODE_DEFAULT);  //HZJ  Want Check again!!
		GPIO_DirectionConfig(GPIO_PORT[OV7725_RRST_PORT], OV7725_RRST_PIN, GPIO_DIR_OUT); 
		GPIO_OpenDrainConfig(GPIO_PORT[OV7725_RRST_PORT], OV7725_RRST_PIN, DISABLE);//HZJ	
 
 	  //OV7725_CS
    AFIO_GPxConfig(OV7725_CS_PORT, OV7725_CS_PIN, AFIO_MODE_DEFAULT);  //HZJ  Want Check again!!
		GPIO_DirectionConfig(GPIO_PORT[OV7725_CS_PORT], OV7725_CS_PIN, GPIO_DIR_OUT); 
		GPIO_OpenDrainConfig(GPIO_PORT[OV7725_CS_PORT], OV7725_CS_PIN, DISABLE);//HZJ	
		

     //OV7725_DATA
    AFIO_GPxConfig(OV7725_DATA_PORT, FIFO_D0_PIN|FIFO_D1_PIN|FIFO_D2_PIN|FIFO_D3_PIN|FIFO_D4_PIN|FIFO_D5_PIN|FIFO_D6_PIN|FIFO_D7_PIN, AFIO_MODE_DEFAULT);  //HZJ  Want Check again!!
		GPIO_DirectionConfig(GPIO_PORT[OV7725_DATA_PORT], FIFO_D0_PIN|FIFO_D1_PIN|FIFO_D2_PIN|FIFO_D3_PIN|FIFO_D4_PIN|FIFO_D5_PIN|FIFO_D6_PIN|FIFO_D7_PIN, GPIO_DIR_IN);
    GPIO_InputConfig(GPIO_PORT[OV7725_DATA_PORT], FIFO_D0_PIN|FIFO_D1_PIN|FIFO_D2_PIN|FIFO_D3_PIN|FIFO_D4_PIN|FIFO_D5_PIN|FIFO_D6_PIN|FIFO_D7_PIN,ENABLE);  	//HZJ Input enable
		GPIO_PullResistorConfig(GPIO_PORT[OV7725_DATA_PORT], FIFO_D0_PIN|FIFO_D1_PIN|FIFO_D2_PIN|FIFO_D3_PIN|FIFO_D4_PIN|FIFO_D5_PIN|FIFO_D6_PIN|FIFO_D7_PIN, GPIO_PR_UP);//HZJ Input PULLUP
