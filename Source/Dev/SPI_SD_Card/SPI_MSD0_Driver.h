...
#define MSD0_card_enable()      	HT_GPIOD->RR = GPIO_PIN_0//GPIO_ResetBits(GPIOA,GPIO_Pin_4)  //HZJ
#define MSD0_card_disable()     	HT_GPIOD->SRR = GPIO_PIN_0//GPIO_SetBits(GPIOA,GPIO_Pin_4)  //HZJ
